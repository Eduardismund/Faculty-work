...
void UI::printRepositoryMenu()
{
    ...
    cout << "\t 5 - Undo." << endl; // Add option for undo
    cout << "\t 6 - Redo." << endl;
	cout << "\t 0 - Back." << endl;
}
...
void UI::updateSongToRepo() {
        ...
        try
        {
            Song oldSong = this->serv.getRepo().findByArtistAndTitle(oldArtist, oldTitle);
            ...
            cout << "Enter the new duration (minutes): ";
            double newMinutes;
            cin >> newMinutes;
            cout << "Enter the new duration (seconds): ";
            double newSeconds;
            cin >> newSeconds;
            cin.ignore();
            ...
            this->serv.updateSong(oldArtist, oldTitle,
                                  newArtist, newTitle, newMinutes, newSeconds, newSource);
            cout << "Song updated successfully!" << endl;
        }
        catch (InexistenSongException& e)
        {
            cout << e.what();
            cout << "No song found with the provided artist and title." << endl;
        }
...
void UI::undo()
{
    this->serv.undo(); // Call the undo method of the service
}

void UI::redo()
{
    this->serv.redo(); // Call the redo method of the service
}
